...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("ShortageCasesListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheShortageCasesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheShortageCasesListGenerated.onFilterBar().iChangeSearchField("Search Term");
